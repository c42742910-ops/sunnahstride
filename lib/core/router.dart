  ...
  static GoRouter router(Ref ref) {
    ...
    return GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path: '/workout/:id',
          builder: (ctx, state) => WorkoutPlayerScreen(workoutId: state.pathParameters['id']!),
        ),
        GoRoute(path: '/paywall',    builder: (_, __) => const PaywallScreen()),
        GoRoute(path: '/food-photo', builder: (_, __) => const FoodPhotoScreen()),
        GoRoute(path: '/body-photo', builder: (_, __) => const BodyPhotoScreen()),
