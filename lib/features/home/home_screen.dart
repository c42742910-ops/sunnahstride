        ...
        children: [
          ...
          if (profile != null)
            Container(
              ...
              child: Text(isAr ? profile.greetingAr() : profile.greetingEn(), style: TextStyle(fontFamily:'Cairo', fontSize: 13, color: isDark ? AppColors.darkText : AppColors.lightText)),
            ),
