...
class _OnboardingState extends ConsumerState<OnboardingScreen>
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(nextLabel ?? t('التالي ←', 'Next →'),
  ...
  Widget _stepLanguage() {
    return SafeArea(child: Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const SizedBox(height: 8),
        const Text('حلال في كل لقمة • Halal in every bite',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: 'Cairo', fontSize: 15, color: Colors.white70, height: 1.6)),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 6),
          Text(label, style: TextStyle(fontFamily: 'Cairo', fontSize: 15, fontWeight: FontWeight.w700, color: sel ? Colors.white : Colors.white70)),
        ]),
      ),
    );
  }
    ...
    return SafeArea(child: Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        Text(
          ...
          textAlign: TextAlign.center,
          style: const TextStyle(fontFamily: 'Cairo', fontSize: 15, color: Colors.white80, height: 1.8),
        ),
        const SizedBox(height: 48),
        ElevatedButton(
          onPressed: _next,
          style: ElevatedButton.styleFrom(backgroundColor: AppColors.barakahGold, padding: const EdgeInsets.symmetric(vertical: 16), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14))),
          child: Text(t('ابدأ رحلتك ✨', 'Start Your Journey ✨'),
  ...
  Widget _stepGender() {
    return SafeArea(child: Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        const SizedBox(height: 20),
        Text(t('اختر طريقك', 'Choose Your Path'),
            textAlign: TextAlign.center,
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(children: [
          ...
          Expanded(child: Text(label, style: TextStyle(fontFamily: 'Cairo', fontSize: 18, fontWeight: FontWeight.w700, color: sel ? Colors.white : Colors.white80))),
    ...
    return _qWrap(
      ...
      child: Column(children: [
        ...
        _sliderRow(
          ...
          label: '$_age ${t("سنة", "yrs")}',
          color: AppColors.sunnahGreen,
        ),
        const SizedBox(height: 14),
        Text(t('نستخدم عمرك لحساب احتياجاتك الدقيقة', 'We use your age to calculate your precise needs'),
            textAlign: TextAlign.center,
  ...
  Widget _stepHeight() {
    return _qWrap(
      emoji: '📏',
      titleAr: 'ما طولك؟ (بالسنتيمتر)',
      titleEn: 'What is your height? (cm)',
      child: Column(children: [
        _whiteCard(TextField(
          ...
          decoration: InputDecoration(
            hintText: '170',
            border: InputBorder.none,
            suffix: Text('cm', style: const TextStyle(color: Colors.grey)),
          ),
  ...
  Widget _stepWeight() {
    return _qWrap(
      emoji: '⚖️',
      titleAr: 'ما وزنك الحالي؟ (كجم)',
      titleEn: 'What is your current weight? (kg)',
      child: Column(children: [
        _whiteCard(TextField(
          ...
          textDirection: TextDirection.ltr,
          style: const TextStyle(fontFamily: 'Cairo', fontSize: 36, fontWeight: FontWeight.w900, color: AppColors.sunnahGreen),
          decoration: InputDecoration(hintText: '70', border: InputBorder.none,
            suffix: Text('kg', style: const TextStyle(color: Colors.grey))),
        ...
        Container(
          ...
          child: Builder(builder: (_) {
            final h = _height / 100;
            final bmi = h > 0 ? _weight / (h * h) : 0.0;
            final cat = bmi < 18.5 ? t('نقص وزن','Underweight') : bmi < 25 ? t('مثالي ✓','Normal ✓') : bmi < 30 ? t('زيادة','Overweight') : t('سمنة','Obese');
            ...
            return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text(t('BMI الآن: ', 'BMI now: '), style: const TextStyle(fontFamily: 'Cairo', color: Colors.white70, fontSize: 13)),
              Text(bmi.toStringAsFixed(1), style: TextStyle(fontFamily: 'Cairo', fontWeight: FontWeight.w900, fontSize: 18, color: col)),
              const SizedBox(width: 8),
              Text(cat, style: TextStyle(fontFamily: 'Cairo', fontSize: 13, color: col)),
            ]);
          }),
        ),
      ]),
  ...
  Widget _stepActivity() {
    return _qWrap(
      emoji: '🏃',
      titleAr: 'مستوى نشاطك اليومي؟',
      titleEn: 'What is your daily activity level?',
      child: Column(
  ...
  Widget _stepGoal() {
    return _qWrap(
      ...
      titleEn: 'What is your primary goal?',
      child: Column(
  ...
  Widget _stepDiet() {
    return _qWrap(
      emoji: '🌿',
      titleAr: 'تفضيلاتك الغذائية؟',
      titleEn: 'Your dietary preferences?',
      child: Column(
        children: DietPreference.values.map((d) => _radioOption<DietPreference>(
          value: d, groupValue: _diet,
          emoji: '🥗',
  ...
  Widget _stepMealsAndSleep() {
    return _qWrap(
      emoji: '🍽️',
      titleAr: 'كم وجبة وكم ساعة نوم؟',
      titleEn: 'How many meals & sleep hours?',
      child: Column(children: [
        Text(t('الوجبات اليومية', 'Daily Meals'), style: const TextStyle(fontFamily: 'Cairo', color: Colors.white, fontWeight: FontWeight.w700, fontSize: 15)),
        const SizedBox(height: 10),
        _sliderRow(value: _meals.toDouble(), min: 1, max: 6, divisions: 5,
          onChanged: (v) => setState(() => _meals = v.toInt()),
          label: '$_meals ${t("وجبات", "meals")}',
          color: AppColors.halalGreen,
        ),
        const SizedBox(height: 20),
        Text(t('ساعات النوم عادةً', 'Usual Sleep Hours'), style: const TextStyle(fontFamily: 'Cairo', color: Colors.white, fontWeight: FontWeight.w700, fontSize: 15)),
        const SizedBox(height: 10),
        _sliderRow(value: _sleep, min: 4, max: 12, divisions: 8,
          onChanged: (v) => setState(() => _sleep = double.parse(v.toStringAsFixed(1))),
          label: '${_sleep.toStringAsFixed(0)} ${t("ساعة", "hrs")}',
          color: AppColors.sleepPurple,
        ),
        const SizedBox(height: 14),
        _infoBox(t('النوم الكافي (7-8 ساعات) يُحسّن الأيض ويُساعد على خسارة الوزن', 'Adequate sleep (7-8 hrs) improves metabolism & aids weight loss')),
      ]),
    );
  }
  ...
  Widget _stepBodyFrame() {
    return _qWrap(
      emoji: '🦴',
      titleAr: 'حجم بنيتك الجسمية (معصمك)؟',
      titleEn: 'Your body frame size (wrist)?',
      child: Column(children: [
        _infoBox(t('قِس محيط معصمك لتحديد إطار جسمك', 'Measure your wrist to determine body frame')),
        const SizedBox(height: 16),
        ...BodyFrame.values.map((f) => _radioOption<BodyFrame>(
          value: f, groupValue: _frame,
          emoji: f == BodyFrame.small ? '🤏' : f == BodyFrame.medium ? '✋' : '🤚',
  ...
  Widget _stepHealthConds() {
    return _qWrap(
      emoji: '🏥',
      titleAr: 'هل لديك حالات صحية؟ (اختياري)',
      titleEn: 'Any health conditions? (optional)',
      child: Column(children: [
        _infoBox(t('نستخدم هذه المعلومات لتخصيص توصياتك الصحية فقط', 'We use this info only to personalize your health recommendations')),
        const SizedBox(height: 14),
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Text(_isAr ? cond.nameAr() : cond.nameEn(),
  ...
  Widget _stepOptional() {
    return _qWrap(
      emoji: '📐',
      titleAr: 'معلومات إضافية (اختيارية)',
      titleEn: 'Additional Info (optional)',
      nextLabel: t('تم ✓', 'Done ✓'),
      child: Column(children: [
        _infoBox(t('هذه المعلومات تزيد دقة حساباتك بشكل كبير', 'This info greatly increases the accuracy of your calculations')),
        const SizedBox(height: 16),
        // Waist
        Text(t('محيط الخصر (سم)', 'Waist Circumference (cm)'), style: const TextStyle(fontFamily: 'Cairo', color: Colors.white70, fontSize: 13)),
        const SizedBox(height: 6),
        _whiteCard(TextField(
          ...
          textAlign: TextAlign.center,
          textDirection: TextDirection.ltr,
          style: const TextStyle(fontFamily: 'Cairo', fontSize: 22, color: AppColors.sunnahGreen),
          decoration: InputDecoration(hintText: t('اختياري', 'Optional'), border: InputBorder.none,
            suffix: const Text('cm', style: TextStyle(color: Colors.grey))),
          onChanged: (v) => _waist = double.tryParse(v),
        )),
        const SizedBox(height: 16),
        // Target weight
        Text(t('وزنك المستهدف (كجم)', 'Target Weight (kg)'), style: const TextStyle(fontFamily: 'Cairo', color: Colors.white70, fontSize: 13)),
        const SizedBox(height: 6),
        _whiteCard(TextField(
  ...
  Widget _stepThankYou() {
    ...
    return SafeArea(child: Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        const Text('🤲', style: TextStyle(fontSize: 72), textAlign: TextAlign.center),
        const SizedBox(height: 16),
        const Text('شُكراً لك\nThank You',
            textAlign: TextAlign.center,
            style: TextStyle(fontFamily: 'Cairo', fontSize: 34, fontWeight: FontWeight.w900, color: Colors.white, height: 1.4)),
        const SizedBox(height: 8),
        Text(t('بارك الله فيك! تم تخصيص تجربتك الكاملة', 'May Allah bless you! Your experience is fully personalized'),
            textAlign: TextAlign.center,
            style: const TextStyle(fontFamily: 'Cairo', fontSize: 14, color: Colors.white70, height: 1.6)),
        const SizedBox(height: 28),
        // Summary card
        Container(
          ...
          child: Column(children: [
            _summaryRow('⚖️', 'BMI', bmi.toStringAsFixed(1)),
            _summaryRow('🔥', t('هدف السعرات', 'Calorie Goal'), '${cGoal.toInt()} kcal/${t("يوم","day")}'),
            _summaryRow('🏃', t('النشاط', 'Activity'), _isAr ? _activity.nameAr() : _activity.nameEn()),
            _summaryRow('🎯', t('الهدف', 'Goal'), _isAr ? _goal.nameAr() : _goal.nameEn()),
          ]),
        ),
  ...
  Widget _summaryRow(String emoji, String label, String value) {
    return Padding(padding: const EdgeInsets.symmetric(vertical: 5), child:
      Row(children: [
        ...
        Expanded(child: Text(label, style: const TextStyle(fontFamily: 'Cairo', color: Colors.white70, fontSize: 13))),
        Text(value, style: const TextStyle(fontFamily: 'Cairo', color: Colors.white, fontWeight: FontWeight.w700, fontSize: 13)),
      ]),
    );
  }
  ...
  Widget _sliderRow({required double value, required double min, required double max,
    ...
    return Column(children: [
      Text(label, style: TextStyle(fontFamily: 'Cairo', fontSize: 22, fontWeight: FontWeight.w900, color: color)),
      Slider(
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text('${min.toInt()}', style: const TextStyle(fontFamily: 'Cairo', color: Colors.white54, fontSize: 11)),
        Text('${max.toInt()}', style: const TextStyle(fontFamily: 'Cairo', color: Colors.white54, fontSize: 11)),
      ]),
    ]);
  }
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 12),
          Expanded(child: Text(_isAr ? labelAr : labelEn, style: TextStyle(fontFamily: 'Cairo', fontSize: 14, fontWeight: sel ? FontWeight.w700 : FontWeight.w400, color: Colors.white))),
  ...
  Widget _infoBox(String text) {
    return Container(
      ...
      child: Text(text, textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Cairo', color: Colors.white70, fontSize: 12, height: 1.5)),
    );
  }
}
